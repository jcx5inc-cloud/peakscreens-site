...
function Logo({ className = '', size = 28, word = true }: { className?: string; size?: number; word?: boolean }) {
  return (
    <div className={`flex items-center gap-2 ${className}`}>
      <svg width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="text-emerald-600"><path d="M3.5 16.5l5.5-9 3.5 6 3-4.5L21 19H4" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"/></svg>
    ...
    <div>
      ...
      <section id="ratecard" className="max-w-6xl mx-auto px-4 py-14">
        ...
        <div className="mt-6 flex flex-wrap gap-3">
          <a href="/PeakScreens_Rate_Card.pdf" className="px-4 py-2 rounded-xl bg-slate-900 text-white">Download rate card (PDF)</a>
          <a href="/PeakScreens_Media_Kit.pdf" className="px-4 py-2 rounded-xl bg-white border border-slate-200">Download media kit (PDF)</a>
        </div>
      </section>
      ...
      <section id="pricing" className="max-w-6xl mx-auto px-4 py-14">
        ...
        <div className="mt-4 flex flex-wrap gap-3">
          <a href="/PeakScreens_Media_Kit.pdf" className="px-4 py-2 rounded-xl bg-white border border-slate-200">Download media kit (PDF)</a>
          <button onClick={() => scrollToId('ratecard')} className="px-4 py-2 rounded-xl bg-slate-900 text-white">View full rate card</button>
        </div>
