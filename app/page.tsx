...
function Logo({
  ...
  return (
    <div className={`flex items-center gap-2 ${className}`}>
      ...
      >
        <path
          d="M3.5 16.5l5.5-9 3.5 6 3-4.5L21 19H4"
          stroke="currentColor"
          strokeWidth="1.8"
          strokeLinecap="round"
      ...
      {word && (
        <span className="font-extrabold tracking-tight">
          Peak<span className="text-emerald-700">Screens</span>
        </span>
      )}
    </div>
  );
  ...
  return (
    <div
      className={`rounded-2xl p-6 border ${
        highlight ? "border-emerald-500 shadow-lg" : "border-slate-200 shadow-sm"
      } bg-white`}
    >
      ...
      <button
        onClick={() => scrollToId("ratecard")}
        className={`mt-6 w-full py-2.5 rounded-xl font-medium ${
          highlight ? "bg-emerald-600 text-white" : "bg-slate-900 text-white"
        }`}
      >
        Request rate card
      </button>
  ...
  return (
    <div>
        ...
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center gap-6">
          ...
          <nav className="ml-auto hidden md:flex items-center gap-6 text-sm">
            ...
            <button
              ...
              className="ml-2 px-3 py-1.5 rounded-xl bg-emerald-600 text-white"
            >
              Book a demo
            </button>
          </nav>
        ...
        <div className="max-w-6xl mx-auto px-4 py-16 md:py-24 grid md:grid-cols-2 items-center gap-10">
          <div>
            <h1 className="text-4xl md:text-5xl font-extrabold leading-tight">
              Summit County&apos;s Mountain-Side{" "}
              <span className="bg-clip-text text-transparent bg-gradient-to-r from-emerald-700 via-emerald-500 to-sky-600">
                Digital Ad Network
              </span>
            </h1>
            <p className="mt-4 text-lg text-slate-700">
              Get your brand in front of skiers, riders, and après crowds across
              Breckenridge, Keystone, Copper, A-Basin, and beyond—on bar TVs,
              gondolas, and hotel lobbies.
            </p>
            <div className="mt-6 flex gap-3">
              ...
              <button
                ...
                className="px-5 py-3 rounded-xl bg-white border border-slate-200 font-medium"
              >
                See pricing
              </button>
            </div>
          ...
          <div className="relative">
            <div className="grid grid-cols-2 gap-3">
              <img
                src="https://www.grapevinebirmingham.com/wp-content/uploads/2022/12/apre-ski-bar-bullring-brum.jpg"
                alt="Après-ski bar with TV screens"
                className="rounded-xl shadow-2xl object-cover h-48 w-full md:h-64"
              />
              <div className="grid gap-3">
                <img
                  src="https://thegondolashop.com/cdn/shop/products/nockalmbahn44_4ddc7353-93d7-4945-a982-b37f9b847f29_1080x.jpg?v=1549048928"
                  alt="Gondola line signage screens"
                  className="rounded-xl shadow-xl object-cover h-24 w-full md:h-32"
                />
                <img
                  src="https://www.norki.com/modules/hiblog/views/img/upload/original/fd0130733f0e62a0477886a799466062.jpg"
                  alt="Hotel lobby screens"
                  className="rounded-xl shadow-xl object-cover h-24 w-full md:h-32"
                />
              </div>
            </div>
            <p className="text-xs text-slate-500 mt-3">
              Lifestyle imagery — representative of placements.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="grid md:grid-cols-2 gap-10 items-start">
          <div>
            ...
            <p className="mt-3 text-slate-700">
              Own the mountain moment. Target by resort, venue type, and time of
              day. Flexible packages from local launches to seasonal brand
              takeovers.
            </p>
            <div className="mt-6 grid sm:grid-cols-2 gap-4">
              <FeatureCard
                icon="🎯"
                title=":15 & :30 Spots"
                desc="High-impact placements optimized for dwell time, with frequency capping across a venue network."
              />
              <FeatureCard
                icon="🕒"
                title="Dayparting"
                desc="Reach breakfast crowds, après, or late-night with time-based scheduling."
              />
              <FeatureCard
                icon="📍"
                title="Geo Targeting"
                desc="Select specific resorts or neighborhoods across Summit County."
              />
              <FeatureCard
                icon="📈"
                title="Reporting"
                desc="Shareable dashboards with play verification and impression estimates."
              />
            </div>
          </div>
        ...
        <div className="grid md:grid-cols-2 gap-10 items-start">
          <div className="rounded-2xl p-6 bg-white border border-slate-200 shadow-sm order-2 md:order-1">
            ...
            <button
              onClick={() =>
                (location.href =
                  "mailto:jimmy@peakscreens.com?subject=Host%20PeakScreens%20at%20my%20venue")
              }
              className="mt-6 px-4 py-2 rounded-xl bg-slate-900 text-white font-medium"
            >
              Host screens at my venue
            </button>
          </div>
          <div className="order-1 md:order-2">
            <h2 className="text-2xl md:text-3xl font-bold">For Venues</h2>
            <p className="mt-3 text-slate-700">
              Enhance the vibe and unlock a new revenue stream. We provide
              hardware, installation, and full content management.
            </p>
            <div className="mt-6 grid sm:grid-cols-3 gap-4">
              <FeatureCard
                icon="🍻"
                title="Après Bars"
                desc="Dynamic highlights, local promos, and events."
              />
              <FeatureCard
                icon="🚡"
                title="Gondola Lines"
                desc="Queue entertainment and sponsor messages."
              />
              <FeatureCard
                icon="🏨"
                title="Hotel Lobbies"
                desc="Wayfinding, weather, and partner ads."
              />
            </div>
          </div>
        </div>
      ...
      <section id="network" className="max-w-6xl mx-auto px-4 py-14">
        ...
        <p className="mt-3 text-slate-700">
          Live across Summit County — growing weekly. Ask about specific venues
          and exclusives.
        </p>
        <div className="mt-6 grid sm:grid-cols-2 md:grid-cols-3 gap-4">
          {[
            ...
            <div
              key={place}
              className="rounded-2xl p-5 border bg-white border-slate-200 shadow-sm flex items-center justify-between"
            >
              <span className="font-medium">{place}</span>
              <span className="text-xs text-slate-500">
                Bars · Gondolas · Hotels
              </span>
            </div>
          ))}
        </div>
      ...
      <section id="specs" className="max-w-6xl mx-auto px-4 py-14">
        ...
        <p className="mt-3 text-slate-700">
          We support industry-standard digital signage formats. Keep it bold,
          legible, and silent-friendly.
        </p>
      ...
      <section id="submit" className="max-w-6xl mx-auto px-4 py-14">
        <div className="grid md:grid-cols-2 gap-10 items-start">
          <div className="rounded-2xl p-6 bg-white border border-slate-200 shadow-sm">
            ...
            <form
              onSubmit={async (e) => {
                ...
                // Honeypot: if filled, treat as bot and bail out
                ...
                const ok = await sendViaFormSubmit({
                  ...
                  Email: f.email.value,
                  "Phone number": f["phone number"]?.value ?? "",
            ...
            >
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-3">
                  {[
                    ...
                    >
                      <input type="checkbox" name="target" value={v} /> {v}
                    </label>
                  ))}
                </div>
              </div>
              <input
                name="budget"
                placeholder="Budget (e.g., $1,500/wk)"
                className="w-full rounded-xl border border-slate-300 px-3 py-2"
              />
              <input
                name="asset"
                placeholder="Asset URL (Dropbox/Drive)"
                className="w-full rounded-xl border border-slate-300 px-3 py-2"
              />
              <textarea
                name="notes"
          ...
          <div>
            ...
            <p className="mt-3 text-slate-700">
              Use this quick form to kick off your campaign. We’ll respond with a
            ...
            <div className="mt-6 rounded-2xl p-6 bg-white border border-slate-200 shadow-sm">
              ...
              <form
                onSubmit={async (e) => {
                  ...
                  if (ok) {
                    alert(
                      "Thanks! Your venue application was sent to PeakScreens."
                    );
                    f.reset();
                  } else {
                    alert(
                      "Sorry, something went wrong sending your application."
                    );
                  }
                }}
                className="mt-4 space-y-3 text-sm"
        ...
        <div className="mt-6 grid md:grid-cols-2 gap-4">
          <div className="rounded-2xl p-6 bg-white border border-slate-200 shadow-sm">
            ...
            <p className="mt-2 text-slate-700 text-sm">
              Same day if assets meet specs and payment is set. Typical is 24–72
              hours.
            </p>
          </div>
          <div className="rounded-2xl p-6 bg-white border border-slate-200 shadow-sm">
            <h3 className="font-semibold">How often will my spot play?</h3>
            <p className="mt-2 text-slate-700 text-sm">
              Depends on share of voice and venue foot traffic. We cap frequency
              for better spread across hours.
            </p>
          </div>
          <div className="rounded-2xl p-6 bg-white border border-slate-200 shadow-sm">
            <h3 className="font-semibold">Can you make our ad?</h3>
            <p className="mt-2 text-slate-700 text-sm">
              Yes—fast-turn creative starting at $300 for static, $750 for
              motion.
            </p>
          </div>
          <div className="rounded-2xl p-6 bg-white border border-slate-200 shadow-sm">
            <h3 className="font-semibold">What formats do you accept?</h3>
            <p className="mt-2 text-slate-700 text-sm">
              MP4 H.264 for video, PNG/JPG for static. 1080p landscape by
              default; portrait on request.
            </p>
          </div>
        </div>
      </section>
      ...
      <section id="ratecard" className="max-w-6xl mx-auto px-4 py-14">
        ...
        <p className="mt-3 text-slate-700">
          Typical packages and inclusions. Custom quotes available for exclusives
            ...
            <tbody>
              ...
              <tr className="border-t bg-slate-50">
                ...
                <td className="p-3" colSpan={4}>
                  Creative production, rush setup, venue exclusivity, on-site
                  activations
                </td>
              </tr>
            </tbody>
      ...
      <section id="pricing" className="max-w-6xl mx-auto px-4 py-14">
        ...
        <p className="mt-3 text-slate-700">
          Packages for locals to national brands. Rates vary by seasonality,
          inventory, and share of voice.
        </p>
        <div className="mt-6 grid md:grid-cols-3 gap-4">
          ...
          />
          <Package
            name="Seasonal Takeover"
            price="Custom"
            bullets={[
              "Category exclusivity",
              "Premium inventory & events",
              "Full-funnel reporting",
            ]}
          />
        </div>
        <p className="text-xs text-slate-500 mt-3">
          *All packages subject to availability. Creative production available on
          request.
        </p>
      </section>
      ...
      <section id="contact" className="max-w-6xl mx-auto px-4 py-14">
        <div className="grid md:grid-cols-2 gap-10">
          <div>
            ...
            <p className="mt-3 text-slate-700">
              Tell us your goals and we&apos;ll propose a flight plan within 24
              hours.
            </p>
            <div className="mt-6 rounded-2xl p-6 bg-white border border-slate-200 shadow-sm">
              <form
        ...
        <div className="mt-6 grid md:grid-cols-2 gap-4">
          ...
          >
            ...
            <div className="text-sm text-slate-700 mt-3 space-y-3">
              <p>
                We collect basic contact info you provide (name, email) and ad
                asset details for campaign setup. We don’t sell your data.
                Analytics are used to improve scheduling and reporting.
              </p>
              <p>
                For removal or data access, email{" "}
                <a
                  className="underline"
                  href="mailto:jimmy@peakscreens.com"
                >
                  jimmy@peakscreens.com
                </a>
                .
              </p>
            </div>
          ...
          >
            ...
            <div className="text-sm text-slate-700 mt-3 space-y-3">
              <p>
                Placements are subject to availability and brand-safety review.
                Proof-of-play is provided via logs; impression estimates are
                directional. Payment due prior to flight unless agreed otherwise.
              </p>
              <p>
                Creative must meet specs and venue standards. Emergency messaging
                may pre-empt programming when required.
              </p>
            </div>
          </details>
        </div>
